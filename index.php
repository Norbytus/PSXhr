...
<body>
    <div class="cont" psxhr="true" psxhr-href="<?= $_SERVER['PHP_SELF']; ?>?get-date=true" psxhr-time="1000" psxhr-callback="testCallback" psxhr-event="click">
        This block must be restart
    </div>
    <!--<a psxhr="true" psxhr-container=".cont" href="<?= $_SERVER['PHP_SELF']; ?>?get-date=true" psxhr-time="1000" psxhr-event="click">Link</a>
